import 'package:carteirinha_uerj_mvp/features/home/screens/home_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _fazerLogin() {
    ...
    if (matriculaDigitada.isEmpty || senhaDigitada.isEmpty) {
    ...
    } else if (matriculaDigitada == simularEstudante.ID) {
      ...
      setState(() {
        _mensagemErro = 'Matrícula não encontrada no sistema';
      });
    }
  }
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(12),
                    borderSide: const BorderSide(color: AppColors.azulUerj, width: 2),
                  ),
                ),
              ),
